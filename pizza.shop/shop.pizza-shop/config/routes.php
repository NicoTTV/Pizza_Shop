...
return function( \Slim\App $app):void {
    ...
    $app->get('/produits[/]', \pizzashop\shop\app\actions\catalogue\ListerProduitsAction::class)
        ->setName('produits');

    $app->get('/produits/{id_produit}[/]', \pizzashop\shop\app\actions\catalogue\AccederProduitAction::class)
        ->setName('produit');

    $app->get('/categories/{id_categorie}/produits[/]', \pizzashop\shop\app\actions\catalogue\ListerProduitsParCategorieAction::class)
